...
% Oznaczonie TODO wskazuje fragmenty kodu wymagające zmian.
    ...
    N = 14; % liczba węzłów interpolacji TODO
    ...
    x_uniform = linspace(-1, 1, N).';      % obliczenie wartości funkcji w węzłach
    ...
    xlabel('x');
    ylabel('y');
title('węzły równomiernie rozmieszczone');
    ...
    xlabel('x');
    ylabel('y');
    title('węzły Czebyszewa II rodzaju');
