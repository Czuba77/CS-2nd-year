...
%       trygonometrycznej.
    ...
    % Wykresy
    subplot(2,1,1);
    plot(1:k_max, rmse_values, 'b-', 'LineWidth', 2);
    ...
    subplot(2,1,2);
    plot(x, y, 'k-', 'DisplayName', 'Dane oryginalne');
    hold on;
    plot(x_fine, ya, 'r-', 'LineWidth', 2, 'DisplayName', sprintf('Aproksymacja trygonometryczna (M = %d)', M));
    title('Aproksymacja trygonometryczna danych');
    xlabel('Numer próbki (czas)');
