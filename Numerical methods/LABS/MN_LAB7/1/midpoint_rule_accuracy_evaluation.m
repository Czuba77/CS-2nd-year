function [ft_5, integral_1000, Nt, integration_error] = midpoint_rule_accuracy_evaluation()
    ...
    title('Błąd całkowania metodą prostokątów w funkcji liczby podprzedziałów');
    grid on;
...
function integral_approximation = midpoint_rule(x)
    ...
    for i = 1:n-1
        ...
        deltaX = x(i+1) - x(i);
        integral_approximation = integral_approximation + failure_density_function(midpoint) * deltaX;
    end
end
